...
//
//  Created by Ryo Song Zi on 08/20/17.
...
class LMRootViewController: LMSideBarController, LMSideBarControllerDelegate {
    ...
    override func awakeFromNib() {
        ...
        let navigationController = self.storyboard?.instantiateViewController(withIdentifier: "mainNavigationController") as! CustomUINavigationViewController
