...
- (id)init
{
    ...
    if (self != nil)
    {
        self.menuWidth = 300;//[UIScreen mainScreen].bounds.size.width * 2/3;
...
{
    _menuWidth = [[UIScreen mainScreen] bounds].size.width * 0.8;//MIN(MAX(menuWidth, 50), [[UIScreen mainScreen] bounds].size.width);
}
